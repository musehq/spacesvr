 ...
 * @constructor
 */
export const AltRangeTool = (props: Props) => {
  const {
    children,
    edit,
    editor,
  ...
  useFrame(() => {
    ...
    if (edit === "" && pos !== undefined && editor && editor.scale.x === 0) {
      ...
      dummyVector.set(xPos * distance, yPos * distance, -DISTANCE * 10);
